...
jedis_ordenados_by_name= jedis.sort(key= by_name)
print("Jedis ordenados por nombre:", jedis_ordenados_by_name)

search_result = search(jedis, "name", "Anakin Skywalker/Darth Vader")
print(f"\nBúsqueda de 'Anakin Skywalker/Darth Vader': {search_result}\n")
remove(jedis, "name", "Anakin Skywalker/Darth Vader")
show_list("Lista de Jedis después de eliminar a 'Anakin Skywalker/Darth Vader':", jedis)
